"""Tests for the lightweight /v1/analyze-document endpoint."""
...
from app.schemas.analyze_document import AnalyzeDocumentRequest
...
class AnalyzeDocumentServiceTest(unittest.TestCase):
    ...
    def test_analyze_returns_ready_to_index_estimates(self) -> None:
        ...
        self.assertEqual(result.rag_status, "READY_TO_INDEX")
        self.assertTrue(result.rag_supported)
    ...
    def test_empty_document_returns_unsupported(self) -> None:
        ...
        self.assertFalse(result.rag_supported)
...
class AnalyzeDocumentApiTest(unittest.TestCase):
    ...
    def test_analyze_endpoint_returns_success_envelope(self) -> None:
        ...
        self.assertEqual(body["data"]["document_id"], 12)
        self.assertEqual(body["data"]["rag_status"], "READY_TO_INDEX")
        self.assertTrue(body["data"]["rag_supported"])
