          ...
          <div className="px-5 py-4 border-b border-[#0E0D0B]/[0.06] flex items-center justify-between flex-shrink-0">
            <div>
              ...
              <p className="text-[12px] text-[#6B6963] mt-0.5">
                {activeCount > 0 ? `Đang kích hoạt ${activeCount} bộ lọc` : "Chưa chọn bộ lọc nào"}
              </p>
            </div>
              ...
              <>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {[
                      ...
                      <button
                        key={opt.value}
                        type="button"
                        onClick={() => onChange({ ...filters, fileType: opt.value })}
                        className={`h-9 rounded-xl text-[12.5px] font-medium border transition-all cursor-pointer ${
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={(e) => onChange({ ...filters, processingStatus: e.target.value })}
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={(e) => onChange({ ...filters, publicationStatus: e.target.value })}
                    className="w-full h-9.5 px-3 bg-white border border-[#0E0D0B]/[0.12] rounded-xl text-[13px] text-[#0E0D0B] focus:border-[#4F63D2] focus:ring-2 focus:ring-[#4F63D2]/10 focus:outline-none cursor-pointer font-sans"
                  >
